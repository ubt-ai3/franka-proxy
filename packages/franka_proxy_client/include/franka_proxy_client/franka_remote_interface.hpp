...
public:
	...
	/**
	 * Start control-loop to move hybrid position/force controlled
	 * along the specified motion.
	 *
	 * @throw remote_exception if the movement was unsuccessful.
	 */
	void move_sequence(
	...
	*/
	...
	/**
	 * Joint space impedance controller for executing a pre-defined calibration motion for payload estimation
	*/
	...
	*/
	 ...
	 *
	 * speed_factor Target speed factor, normalized between 0 and 1.
	 */
	...
	*
	* bias of the ft sensor (fx, fy, fz, tx, ty, tz)
	*/
	...
	*/
	...
	/**
	* Send which cartesian DOF of the robot are hand-guidable;
	* true equals mobile and false equals immobile
	*/
...
private:
	...
	/**
	 * Constructs a command in-place with given arguments, and checks the response code,
	 ...
	 */
	template <typename TCommandType, typename... TArgs> TResponseType<TCommandType> send_command(TArgs&&... args)
	{
	...
	vacuum_gripper_state current_vacuum_gripper_state_;
};
} /* namespace franka_proxy */
