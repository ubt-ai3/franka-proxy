...
void admittance_motion_generator::set_impedance_rotational_stiffness(double rotational_stiffness)
{
	...
	else
	{
		throw std::runtime_error(
			"(Admittance controller) Setting impedance rotational stiffness after initialization is not allowed!");
	}
}
...
void admittance_motion_generator::set_impedance_translational_stiffness(double translational_stiffness)
{
	...
	{
		throw std::runtime_error(
			"(Admittance controller) Setting impedance translational stiffness after initialization is not allowed!");
	}
}
