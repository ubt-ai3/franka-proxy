#ifndef INCLUDED__FRANKA_PROXY__MOTION_GENERATOR_CARTESIAN_IMPEDANCE_HPP
...
private:
	...
	std::vector<std::string> f_head = {
		"f_ext_x", "f_ext_y", "f_ext_z", "f_ext_r_x", "f_ext_r_y", "f_ext_r_z",
		"s1", "s2", "s3", "s4", "s5", "s6", "d1", "d2", "d3", "d4", "d5", "d6"
	};
	std::vector<std::string> s_head = {"time"};
	std::vector<std::string> c_head = {
		"position_d_x", "position_d_y", "position_d_z", "rotation_d_x", "rotation_d_y", "rotation_d_z",
...
#endif // INCLUDED__FRANKA_PROXY__MOTION_GENERATOR_CARTESIAN_IMPEDANCE_HPP
