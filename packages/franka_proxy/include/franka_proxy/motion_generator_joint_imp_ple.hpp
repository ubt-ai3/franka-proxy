#ifndef INCLUDED__FRANKA_PROXY__MOTION_GENERATOR_JOINT_IMP_PLE_HPP
 ...
 *
 * Variant of the joint space based impedance controller, for use
...
private:
	...
	bool done_ = false;
	// whether the motion is done up to a point where the robot can safely come to a complete stop immediately
...
#endif // INCLUDED__FRANKA_PROXY__MOTION_GENERATOR_JOINT_IMP_PLE_HPP
