...
public:
	 ...
	 */
	void start_recording(const std::optional<std::string>& log_file_path = std::nullopt);
	std::pair<std::vector<robot_config_7dof>, std::vector<wrench>> stop_recording();
	std::pair<std::vector<robot_config_7dof>, std::vector<wrench>> start_recording(float seconds, const std::optional<std::string>& log_file_path = std::nullopt);
	...
	*/
	void cartesian_impedance_poses(
		...
		double translational_stiffness, const std::optional<std::string>& log_file_path = std::nullopt);
	/**
	...
	void joint_impedance_hold_position(
		double duration, const std::array<double, 49>& stiffness, const std::optional<std::string>& log_file_path = std::nullopt);
	/**
	...
	*/
	void joint_impedance_positions(
		...
		const std::array<double, 49>& stiffness, const std::optional<std::string>& log_file_path = std::nullopt);

	/**
	 *  Runs the pre-defined motion for payload estimation
	*/
	void run_payload_estimation(double speed,  double duration, const std::optional<std::string>& log_file_path = std::nullopt);
