...
void motion_recorder::start(const std::optional<std::string>& log_file_path)
{
	stop_ = false;
...
std::pair<std::vector<std::array<double, 7>>, std::vector<std::array<double, 6>>> motion_recorder::start(float seconds, const std::optional<std::string>& log_file_path)
{
	start(log_file_path);
