...
int main()
{
	...
	controller.joint_impedance_hold_position(10, true);

	std::cout << "Finished Impedance - Hold Position Test." << std::endl;

	std::cout << "Starting Impedance - Follow Poses Test." << std::endl;
	// positions
	...
	controller.cartesian_impedance_poses(poses, 10, true, false);

	std::cout << "Finished Impedance - Follow Poses Test." << std::endl;

	std::cout << "Starting Admittance - Apply Force Test." << std::endl;

	controller.apply_admittance(10, true);
