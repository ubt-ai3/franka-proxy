...
#if !defined(INCLUDED__FRANKA_PROXY__FORCE_TORQUE_SENSOR_JR3PCIIOCTLS_HPP)
#define INCLUDED__FRANKA_PROXY__FORCE_TORQUE_SENSOR_JR3PCIIOCTLS_HPP
...
#endif /* !defined(INCLUDED__FRANKA_PROXY__FORCE_TORQUE_SENSOR_JR3PCIIOCTLS_HPP) */
